...
## Project Overview
This project is an end-to-end Machine Learning pipeline designed to predict cardiovascular disease risk based on clinical patient markers. By utilizing historical health data, we built a tool that assists healthcare providers in identifying high-risk individuals for early intervention.

## Team
* **Member 1: ALAKIIR CHOL
* **Member 2: GILLIAN BANGMIA
